 ...
 <li class="nav-item">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
         ...
         <br>
          <div id="transfer">
                 <strong> <h1>List of Users</h1> </div></strong>
         <%
       ...
       // String cid=session.getAttribute("cid").toString();
        ...
        String sql2="select caccountno,cuser,cemail,currentbal from customers";
        ...
        out.println("<tr><th>Customer account no</th><th>Customer Name</th><th>Email</th><th>Current balance</th></tr>");
